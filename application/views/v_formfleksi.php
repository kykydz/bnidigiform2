	...
	<div class="container mt">
		<div class="row mt polaroidhasil">
			<div class="col">
					...
					<h3 align="center">FORM PENGAJUAN BNI FLEKSI</h3>
					<br>
				  	<div class="row">
					    <div class="col">
					      	<label>NIK</label>
					    ...
					    <div class="col">
					      	...
					      	<input class="form-control" name="alamatktp">
					    </div>
					</div>
					<div class="row">
					    <div class="col">
					    ...
					    <div class="col">
					      	...
					      	<input class="form-control" name="tggllahir">
					    </div>
					    <div class="col">
					      	<label>Alamat Sekarang</label>
					      	<input class="form-control" name="alamatnow">
					    </div>
					</div>
					<div class="row">
					    <div class="col">
					...
					<div class="row">
					    ...
					    <div class="col">
					      	...
					      	<input class="form-control" name="payroll">
					    </div>
					</div>
					<br>
