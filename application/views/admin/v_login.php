...
<div class="login-box">
  <div class="login-logo">
    <a href="../../index2.html"><b>BNI-FORM</b>DASHBOARD</a>
  </div>
  <!-- /.login-logo -->
  ...
  <div class="login-box-body">
    ...
    <form action="<?php echo site_url().'administrator/auth'?>" method="post" autocomplete="off">
    ...
    <a href="http://bnidigiform.wallezzdev.com">BNI DIGIFORM</a><br>
